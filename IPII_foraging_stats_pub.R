...
base_name<-'sm_utt_seg_means_20_5_100_clean.csv'
...
print(base_name)
IPII_topic_run_data_dir<-paste0(dir_foraging_data, base_name)
...
for (var in variable_list) {
    ...
    if (var=='length'){
      model <- lm(length ~ PANSS_cognitive_sx_total_LysakerFactor+PANSS_negative_sx_total_LysakerFactor+PANSS_positive_sx_total_LysakerFactor, data = df_to_test)
